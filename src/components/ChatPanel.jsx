...
Open question (S4, "one thing helping, or one thing getting in the way"): ${openEndedSplitS4?.n ?? 0} answers, ${openEndedSplitS4?.helpingN ?? 0} helping, ${openEndedSplitS4?.hinderingN ?? 0} in the way${openEndedSplitS4?.mixedN ? `, ${openEndedSplitS4.mixedN} both` : ''}${openEndedSplitS4?.noneN ? `, ${openEndedSplitS4.noneN} typed N/A` : ''}.
