...
const CHAPTERS = [
  ...
  },
  {
    ...
    narrative: `Fourteen months in, AI is woven into the daily rhythm of how this team works. 92% of respondents use it every day — a figure that would have seemed ambitious at the start. Positive sentiment held strong at 69%, and confidence continued climbing toward 4.0. For the first time, we captured role and function data, revealing that while adoption is near-universal, the depth of use and the barriers people face still vary meaningfully across the team.`,
  },
];
